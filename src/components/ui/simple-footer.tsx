...
export function Footer({
  ...
  return (
    <footer className="pb-6 pt-16 lg:pb-8 lg:pt-24 bg-zinc-900 text-white">
            ...
            <ul className="list-none flex flex-wrap -my-1 -mx-3 lg:justify-end">
              {legalLinks.map((link, i) => (
                <li key={i} className="my-1 mx-3 shrink-0">
                  <a
                    href={link.href}
                    className="text-sm text-white/60 underline-offset-4 hover:underline hover:text-white/80"
                  >
                    {link.label}
                  </a>
                </li>
